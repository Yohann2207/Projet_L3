...
public class Emprunt {
    ...
    public String toString() {
         return "ID: " + id + " | Utilisateur: " + utilisateur.getNom() + " | Ressource: " + ressource.getNom() + " | Début: " + date_emprunt + " | Limite: " + date_limite  + " | état: " + etat;
    }
    ...
    public static ArrayList<Emprunt> recupererTousS(ArrayList<Utilisateur> utilisateurs, ArrayList<Ressource> ressources) {
        return BDD.recupererTousLesEmprunts(utilisateurs, ressources);
    }
    
    public ArrayList<Emprunt> recupererTous(ArrayList<Utilisateur> utilisateurs, ArrayList<Ressource> ressources) {
        return BDD.recupererTousLesEmprunts(utilisateurs, ressources);
    }
